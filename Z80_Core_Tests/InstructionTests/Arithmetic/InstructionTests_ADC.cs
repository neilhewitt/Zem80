...
namespace Z80.Core.Tests
{
    ...
    public class InstructionTests_ADC : InstructionTestBase
    {
        ...
        [TestCase(0x1000, 0xF000, false, 0x0000, FlagState.Carry | FlagState.Zero)]
        [TestCase(0x0000, 0xFFFF, true, 0x0000, FlagState.Carry | FlagState.ParityOverflow | FlagState.Zero)]
        ...
        [TestCase(0x9000, 0xF000, false, 0x8000, FlagState.Carry | FlagState.ParityOverflow | FlagState.Zero | FlagState.Sign)]
