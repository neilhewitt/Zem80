...
namespace Z80.Core.Tests
{
    ...
    public class InstructionTests_RES : InstructionTestBase
    {
        ...
        public void RES_r(RegisterIndex register, int bitIndex)
        {
        ...
        [Test]
        public void RES_xIndexOffset([Values(RegisterPairIndex.IX, RegisterPairIndex.IY)] RegisterPairIndex registerPair, [Range(0, 6)] byte bitIndex)
        {
            IFlags currentFlags = Flags;
            byte initialValue = RandomByte();
            byte resetValue = initialValue.SetBit(bitIndex, false);
