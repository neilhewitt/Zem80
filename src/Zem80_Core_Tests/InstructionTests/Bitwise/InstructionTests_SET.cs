...
namespace Z80.Core.Tests
{
    ...
    public class InstructionTests_SET : InstructionTestBase
    {
        ...
        public void SET_r()
        {
            ...
            ExecutionResult executionResult = ExecuteInstruction($"SET { bitIndex },B");
        ...
        public void SET_xHL()
        {
            ...
            ExecutionResult executionResult = ExecuteInstruction($"SET { bitIndex },(HL)");
        ...
        [Test]
        public void SET_xIndexOffset([Values(WordRegister.IX, WordRegister.IY)] WordRegister registerPair, [Values(0x7F, -0x80)] sbyte offset)
        {
            Flags initialFlags = Flags;
            byte initialValue = 0x00;
            byte bitIndex = 4;
            ...
            ExecutionResult executionResult = ExecuteInstruction($"SET { bitIndex },({ registerPair }+o)", arg1: (byte)offset);
