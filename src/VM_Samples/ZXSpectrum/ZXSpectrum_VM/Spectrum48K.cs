...
namespace ZXSpectrum.VM
{
    public class Spectrum48K
    {
        ...
        public void Start(string snapshotPath = null)
        {
            ...
            {
                if (snapshotPath != null) _loader.LoadSnapshot(snapshotPath); // snapshot loading must happen after CPU is initialised, but before it starts
            };
        ...
        public Spectrum48K(EventHandler<byte[]> OnUpdateDisplay)
        {
            ...
            _loader = new Loader(_cpu, _ula); // handles loading of snapshots
